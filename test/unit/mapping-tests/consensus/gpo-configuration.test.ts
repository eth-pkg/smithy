...
describe.skip('Consensus Client Gas Price Oracle Configuration Tests', () => {
  ...
  consensusClients.forEach(client => {
    describe(`${client} gas price oracle configuration`, () => {
      it('should not include any gas price oracle flags when gas price oracle is disabled', () => {
